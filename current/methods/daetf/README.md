...
`spectralflow/spectralflow`'s spatial-only `RangeNullProjector` to the joint
operator `A = [D; R]`:
...
```powershell
$env:PYTHONPATH="common;methods"; python -c "import daetf.ambiguity as a; a._selfcheck.run_all()"
$env:PYTHONPATH="common;methods"; python -c "import daetf.ambiguity.auditor_selfcheck as au; au.run_all()"
```
