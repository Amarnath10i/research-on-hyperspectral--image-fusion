...
from krylovnet.rankest.generator import RankScene, make_srf
from daetf.ambiguity.operator import CombinedOperator
...
def check_predictive(rank: int = 8, bands: int = 31):
    ...
    from krylovnet.model_selection import (spectral_null_fraction,
