...
P1 paper extends it to the combined `A=[D;R]` in `daetf/ambiguity`.
...
```powershell
$env:PYTHONPATH="common;methods"; python -c "import manifoldflow; manifoldflow._selfcheck.run_all()"
$env:PYTHONPATH="common;methods"; python -c "import spectralflow; spectralflow._selfcheck.run_all()"
```