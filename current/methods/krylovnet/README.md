...
python -c "import krylovnet.rankest as r; r._selfcheck.run_all()"
python -c "import krylovnet.model_selection_selfcheck as m; m.run_all()"
python -m krylovnet.experiments.synthetic_rank_sweep   # etc.
```
