...
insert_ckpt_restore('continuumfusion/notebooks/continuumfusion_Kaggle_GPU.ipynb', 'amarnath10chinu/continuumfusion-checkpoint', 'continuumfusion')
insert_ckpt_restore('zerofusion/notebooks/zerofusion_Kaggle_GPU.ipynb', 'amarnath10chinu/zerofusion-checkpoint', 'zerofusion')
