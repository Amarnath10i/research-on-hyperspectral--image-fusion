...
NOTEBOOKS = {
    "proposal1": ("methods/daetf/notebooks/DAETF_Net_Kaggle_GPU.ipynb", "daetf-net-fusion"),
    "proposal2": ("methods/krylovnet/notebooks/unfoldfusion_Kaggle_GPU.ipynb", "unfoldfusion-fusion"),
    "proposal3": ("methods/continuumfusion/notebooks/continuumfusion_Kaggle_GPU.ipynb", "continuumfusion-fusion"),
    "proposal4": ("methods/zerofusion/notebooks/zerofusion_Kaggle_GPU.ipynb", "zerofusion-fusion"),
    "proposal7": ("methods/nullfusion/notebooks/nullfusion_SOTA_CAVE_Nikon.ipynb", "nullfusion-v4-cave-x4-v2"),
}
...
def main() -> int:
    ...
    p.add_argument("--state-dir", default=os.path.join(REPO, "results", "kaggle_runs"))
    a = p.parse_args()
