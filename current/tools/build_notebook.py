...
PKG = os.path.join(REPO, "methods", "daetf", "daetf")
OUT = os.path.join(REPO, "methods", "daetf", "notebooks", "DAETF_Net_Kaggle_GPU.ipynb")
...
`git clone`, no internet needed. Generated from `daetf/daetf/` by
