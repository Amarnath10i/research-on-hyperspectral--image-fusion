...
for d in [str(ROOT / "common"), str(ROOT / "methods" / "daetf"), str(ROOT / "methods" / "krylovnet"),
          str(ROOT / "methods" / "continuumfusion"), str(ROOT / "methods" / "zerofusion"), str(ROOT / "methods" / "spectralflow")]:
