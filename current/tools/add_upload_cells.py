...
notebooks = [
    (
        "daetf/notebooks/DAETF_Net_Kaggle_GPU.ipynb",
        "daetf_out",
        "amarnath10chinu/daetf-net-checkpoint",
        "DAETF-Net Checkpoint",
    ),
    (
        "krylovnet/notebooks/unfoldfusion_Kaggle_GPU.ipynb",
        "unfoldfusion_out",
        "amarnath10chinu/unfoldfusion-checkpoint",
        "UnfoldFusion Checkpoint",
    ),
    (
        "continuumfusion/notebooks/continuumfusion_Kaggle_GPU.ipynb",
        "continuumfusion_out",
        "amarnath10chinu/continuumfusion-checkpoint",
        "ContinuumFusion Checkpoint",
    ),
    (
        "zerofusion/notebooks/zerofusion_Kaggle_GPU.ipynb",
        "zerofusion_out",
