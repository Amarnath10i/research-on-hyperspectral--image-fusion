...
|---|---|---|
| wang2026equivariant | DOI 10.1109/TIP.2026.3537982; datasets CAVE/Chikusei | DOI **10.1109/TIP.2026.3657219**; datasets **Houston/ICVL** |
...
## Dataset conventions
- **Simulated (Wald)**: Houston (×8), Chikusei (×8), Pavia/ICVL.
